...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> {
    ...
    public MusicAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.main_adapter_layout, null));
    }
    ...
    public void onBindViewHolder(@NonNull MusicAdapter.MyViewHolder holder, int position) {
        ...
        if (list2.isPlaying()) {
            ...
            holder.rootLayout.setBackgroundResource(R.drawable.round_back_blue10);
        }else {
            holder.rootLayout.setBackgroundResource(R.drawable.round_back10);
        }
        ...
        holder.artists.setText(list2.getArtists());
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            artists = itemView.findViewById(R.id.musicArtist);
