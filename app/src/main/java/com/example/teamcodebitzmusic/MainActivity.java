    ...
    public void getMusicFiles() {
        ...
        if(cursor == null) {
            ...
            while (cursor.moveToNext()){
                ...
                Uri musicFileUris = ContentUris.withAppendedId(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, cursorID);
                ...
                final MusicList musicList = new MusicList(getMusicFileName, getArtistName, getDuration, false, musicFileUris);
